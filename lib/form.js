...
let Form = function (fields = [], model) {
  ...
  if(model && config.getModelStrategy() === null) {
    throw new Error('If you pass a model, you must set a model strategy')
  }
...
module.exports = {
  ...
  setValidationMethod: (method) => config.setValidationMethod(method),
