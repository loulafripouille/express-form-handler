...
var Field = function() {
    ...
    {
        this.ErrorHandler = new ErrorHandler(locale);
        this.Constraint = new Constraint(this.ErrorHandler, this.fields);

        this.checkType(field, function(err) {
            if (err) return cb(err);

            this.checkConstraints(field, function(err){
                return cb(err);
            });
        });
