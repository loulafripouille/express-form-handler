...
var Form = function() {
    ...
    this.handleRequest = function()
    {
        ...
        return function(req, res, next) {
            _this.body = req.body;
            _this.Constraint = new Constraint();
            _this.errors = [];
    ...
    this.checkTypeIntegrity = function(field, fieldName)
    {
        ...
        if(this.validator.hasOwnProperty(validatorMethodName) && typeof this.validator[validatorMethodName] === 'function') {
            ...
            if(false === this.validator[validatorMethodName](this.body[fieldName])) {
                this.errors.push({fieldName: field.type.message || 'This field must respect the ' + fieldType + ' format'});
        ...
        throw new Error('No field-type found for the given field-type ' + fieldType);
    };
